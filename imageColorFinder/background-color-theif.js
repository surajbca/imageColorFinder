 ...
 *
 * */
BackgroundColorTheif.prototype.getBackGroundColor = function (
  sourceImage,
  quality
) {
 ...
 *
 */
BackgroundColorTheif.prototype.getPalette = function (
  sourceImage,
  colorCount,
  quality
) {
  ...
  for (
    var i = (image.getHeight() - heightLimit) * image.getWidth(),
      offset,
      r,
      g,
      b,
  ...
  for (
    var i = heightLimit * image.getWidth(), offset, r, g, b, a, j = 0, k = 0;
    i < pixelCount;
    i = i + quality
  ) {
    offset = i * 4;
  ...
  for (
    var i =
        heightLimit * image.getWidth() +
        (image.getWidth() - widthLimit - quality),
      offset,
      r,
      g,
      b,
